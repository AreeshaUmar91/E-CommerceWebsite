...
<body>
 ...
 <li><a href="login.php">Login</a></li>
  ...
  <!-- Home Page -->
  <!-- Login Form with Phone Number Verification -->
  <center>
    ...
    <!-- <div class="login-form">
      ...
      <div id="verificationSection" style="display:none;">
        ...
        <input type="text" id="verificationCode" name="verificationCode" placeholder="Enter the code you received"
          required><br><br>
